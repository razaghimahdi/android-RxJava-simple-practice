package com.example.rxjavaudemy01.view.part21;
...
import com.example.rxjavaudemy01.adapter.part21.MyDialog;
import com.example.rxjavaudemy01.db.part21.ToDoDataManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        closeImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AddToDoActivity.this, Part21Activity.class);
        ...
        saveImageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (false) {
                    ...
                    Intent main = new Intent(AddToDoActivity.this, Part21Activity.class)
